...
## Model Overview
- **Model Name**: efficientnetb5_cars
...
mkdir -p model_repository/efficientnetb5_cars/1
cp model.onnx model_repository/efficientnetb5_cars/1/
cp config.pbtxt model_repository/efficientnetb5_cars/
```
...
# Run inference
results = client.infer("efficientnetb5_cars", inputs, outputs=outputs)
...
```bash
# Check model status
curl localhost:8000/v2/models/efficientnetb5_cars
