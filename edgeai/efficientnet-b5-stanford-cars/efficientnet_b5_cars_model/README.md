# EfficientNet-b5 Stanford Cars Model - Triton Deployment

## Model Overview
- **Model Name**: efficientnet_b5_cars
...
mkdir -p model_repository/efficientnet_b5_cars/1
cp model.onnx model_repository/efficientnet_b5_cars/1/
cp config.pbtxt model_repository/efficientnet_b5_cars/
```
...
# Run inference
results = client.infer("efficientnet_b5_cars", inputs, outputs=outputs)
...
```bash
# Check model status
curl localhost:8000/v2/models/efficientnet_b5_cars
...
This configuration is optimized for production deployment of EfficientNet-b5 models.
