# ResNet101 Stanford Cars Model - Triton Deployment

## Model Overview
- **Model Name**: resnet101_cars
...
mkdir -p model_repository/resnet101_cars/1
cp model.onnx model_repository/resnet101_cars/1/
cp config.pbtxt model_repository/resnet101_cars/
```
...
# Run inference
results = client.infer("resnet101_cars", inputs, outputs=outputs)
...
```bash
# Check model status
curl localhost:8000/v2/models/resnet101_cars
...
This configuration is optimized for production deployment of ResNet101 models.
